      ...
      <div id='kt_account_signin_method' className='collapse show'>
        <div className='card-body border-top p-9'>
          <div className='d-flex flex-wrap align-items-center'>
              ...
              >
                ...
                <div className='d-flex'>
                  <button
                    id='kt_signin_submit'
                    type='submit'
                    className='btn btn-info  me-2 px-6'
                  >
                  ...
                  <button
                    ...
                    className='btn btn-color-gray-500 btn-active-light-info px-6'
                  >
                    Cancel
                  </button>
                </div>
            ...
            <div id='kt_signin_email_button' className={'ms-auto ' + (showEmailForm && 'd-none')}>
              <button
                ...
                className='btn btn-light btn-active-light-info'
              >
                Change Email
              </button>
            </div>
          ...
          <div className='notice d-flex bg-light-info rounded border-info border border-dashed p-6'>
            <KTIcon iconName='shield-tick' className='fs-2tx text-info me-4' />
            <div className='d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap'>
              ...
              <a
                href='#'
                className='btn btn-info px-6 align-self-center text-nowrap'
